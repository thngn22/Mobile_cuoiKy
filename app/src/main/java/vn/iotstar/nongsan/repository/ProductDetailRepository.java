...
public class ProductDetailRepository {
    ...
    public MutableLiveData<ProductDetailModel> getProductDetailModel(String productId) {
        MutableLiveData<ProductDetailModel> data = new MutableLiveData<>();
        nongSanAPI.getProductDetail(productId).enqueue(new Callback<ProductDetailModel>() {
            @Override
